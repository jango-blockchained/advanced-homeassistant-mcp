...
class HomeAssistantClimateService {
    ...
    async getClimateDevice(entity_id) {
        try {
            const hass = await get_hass();
    ...
    async setHvacMode(entity_id, hvac_mode) {
        try {
            const hass = await get_hass();
    ...
    async setTemperature(entity_id, temperature, target_temp_high, target_temp_low) {
        try {
            const hass = await get_hass();
    ...
    async setFanMode(entity_id, fan_mode) {
        try {
            const hass = await get_hass();
...
async function executeClimateControlLogic(params) {
    let success;
    let deviceDetails;
    switch (params.action) {
        ...
        case "set_temperature": {
            ...
            success = await haClimateService.setTemperature(params.entity_id, params.temperature, params.target_temp_high, params.target_temp_low);
            if (!success) {
...
// --- Tool Definition ---
export const climateControlTool = {
