...
const automationConditionSchema = z.lazy(() => z
    .object({
    alias: z
        .string()
        .optional()
...
const automationActionSchema = z.lazy(() => z
    .object({
    alias: z
        .string()
        .optional()
...
export const automationConfigTool = {
        ...
        try {
            switch (params.action) {
                ...
                case "duplicate": {
                    ...
                    const newAutomation = (await createResponse.json());
                    return {
                        success: true,
